/**
 * Stage 116 launcher verification — packaged app after ReportsAuditPatchSection.
 */
...
report.ui = {
  ...
  reportsTab: /Architecture Health/i.test(reportsBody),
  auditPatchSections:
    /Code Context Pack/i.test(reportsBody) &&
    /Patch Draft Mode/i.test(reportsBody) &&
    /Manual Patch Draft Import/i.test(reportsBody) &&
    /Builder Handoff Export/i.test(reportsBody),
  architectureSections:
    /Architecture Health/i.test(reportsBody) &&
    /Architecture Refactor Task Cards/i.test(reportsBody) &&
    /Architecture Refactor Implementation Intake/i.test(reportsBody),
...
report.pass =
  ...
  report.ui.auditPatchSections &&
  report.ui.architectureSections &&
