/**
 * Stage 130 launcher verification — packaged app after Stage 129 First Guarded Safe Scaffold Write.
 */
...
report.ui = {
  ...
  buildTab: /Safe Scaffold Mode/i.test(buildBody),
  planningOnly: /Planning Only/i.test(buildBody),
  targetFolder: /Safe Scaffold Target Folder/i.test(buildBody),
  fileTreePreview: /Safe Scaffold File Tree Preview/i.test(buildBody),
  fileContentPreview: /Safe Scaffold File Content Preview/i.test(buildBody),
  writeManifestPreview: /Safe Scaffold Write Manifest Preview/i.test(buildBody),
  finalConfirmation: /Safe Scaffold Final Confirmation/i.test(buildBody),
  safeScaffoldWrite: /Safe Scaffold Write/i.test(buildBody),
  writeSafeScaffoldFiles: /Write Safe Scaffold Files/i.test(buildBody),
  recheckWriteReadiness: /Re-check Write Readiness/i.test(buildBody),
  reviewFinalConfirm: /Review Final Confirmation/i.test(buildBody),
  generateManifest: /Generate Write Manifest Preview/i.test(buildBody),
...
report.pass =
  ...
  report.ui.usesAsar &&
  report.ui.buildTab &&
  report.ui.planningOnly &&
  report.ui.targetFolder &&
  report.ui.fileTreePreview &&
  report.ui.fileContentPreview &&
  report.ui.writeManifestPreview &&
  report.ui.finalConfirmation &&
  report.ui.safeScaffoldWrite &&
  report.ui.writeSafeScaffoldFiles &&
  report.ui.recheckWriteReadiness &&
  report.ui.reviewFinalConfirm &&
  report.ui.generateManifest &&
