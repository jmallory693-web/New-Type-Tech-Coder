/**
 * Stage 107 launcher verification — packaged app + Architecture Refactor Implementation Intake.
 */
...
report.ui = {
  ...
  reportsTab: /Architecture Health/i.test(body),
  refactorSection: /Architecture Refactor Task Cards/i.test(body),
  handoffSection: /Architecture Refactor Builder Handoff/i.test(body),
  intakeSection: /Architecture Refactor Implementation Intake/i.test(body),
  saveIntakeButton: /Save Refactor Implementation Report/i.test(body),
...
report.pass =
  ...
  !report.ui.usesVite &&
  report.ui.usesAsar &&
  report.ui.refactorSection &&
  report.ui.handoffSection &&
  report.ui.intakeSection &&
  report.ui.saveIntakeButton &&
