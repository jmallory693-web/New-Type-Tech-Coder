/**
 * Stage 122 launcher verification — packaged app after Safe Scaffold File Tree Preview.
 */
...
report.ui = {
  ...
  generateTree: /Generate File Tree Preview/i.test(buildBody),
