/**
 * Stage 136 launcher verification — packaged app after Stage 135 Local Coder Task Prompt.
 */
...
report.ui = {
  ...
  localCoderTaskPrompt: /Local Coder Task Prompt/i.test(buildBody),
  sectionOrderOk: orderOk === true,
  generateCoderPrompt: /Generate Coder Prompt/i.test(buildBody),
...
report.pass =
  ...
  report.ui.localCoderTaskPrompt &&
  report.ui.sectionOrderOk &&
  report.ui.generateCoderPrompt &&
