/**
 * Stage 89 launcher verification: bat starts packaged exe; Task Builder Handoff spot-check.
 */
...
report.ui = {
  ...
  generateHandoffBtn: /Generate Task Builder Handoff/i.test(body),
};
ws.close();
spawn("taskkill", ["/F", "/IM", "New Type Tech Coder.exe"], { stdio: "ignore" });
