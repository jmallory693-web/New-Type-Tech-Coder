/**
 * Stage 95 launcher verification: bat starts packaged exe; Task Artifact Index spot-check.
 */
...
report.ui = {
  ...
  reconciliationSection: /Blueprint Task Reconciliation/i.test(body),
  artifactIndexSection: /Task Artifact Index/i.test(body),
  artifactIndexAfterReconciliation:
    body.indexOf("Blueprint Task Reconciliation") <
    body.indexOf("Task Artifact Index"),
  generateIndexBtn: /Generate Task Artifact Index/i.test(body),
...
report.pass =
  ...
  !report.ui.usesVite &&
  report.ui.usesAsar &&
  report.ui.artifactIndexSection &&
  report.ui.artifactIndexAfterReconciliation &&
  report.ui.generateIndexBtn &&
