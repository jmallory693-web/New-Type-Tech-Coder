/**
 * Stage 124 launcher verification — packaged app after Safe Scaffold File Content Preview.
 */
...
report.ui = {
  ...
  generateContent: /Generate File Content Preview/i.test(buildBody),
