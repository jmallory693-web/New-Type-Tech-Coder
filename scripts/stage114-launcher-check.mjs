/**
 * Stage 114 launcher verification — packaged app after BlueprintTabSection extraction.
 */
...
report.ui = {
  ...
  blueprintPlanner: /Build From Idea/i.test(blueprintBody),
  ...
  architectureSections:
    ...
    /Architecture Refactor Builder Handoff/i.test(reportsBody) &&
