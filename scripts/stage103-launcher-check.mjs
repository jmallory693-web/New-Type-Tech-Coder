/**
 * Stage 103 launcher verification — packaged app + Architecture Refactor Task Cards.
 */
...
report.ui = {
  ...
  generateRefactorButton: /Generate Refactor Task Cards/i.test(body),
...
report.pass =
  ...
  report.ui.generateRefactorButton &&
