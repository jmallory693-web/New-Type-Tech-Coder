/**
 * Stage 93 launcher verification: bat starts packaged exe; Task Reconciliation spot-check.
 */
...
report.ui = {
  ...
  reconciliationAfterIntake:
    body.indexOf("Task Implementation Intake") <
    body.indexOf("Blueprint Task Reconciliation"),
  generateReconBtn: /Generate Reconciliation Report/i.test(body),
...
report.pass =
  ...
  !report.ui.usesVite &&
  report.ui.usesAsar &&
  report.ui.reconciliationSection &&
  report.ui.reconciliationAfterIntake &&
  report.ui.generateReconBtn &&
