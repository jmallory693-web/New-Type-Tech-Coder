/**
 * Stage 120 launcher verification — packaged app after Safe Scaffold Target Folder.
 */
...
report.ui = {
  ...
  selectTarget: /Select Target Folder/i.test(buildBody),
